	...
	public static void main(String[] args) {
		...
		switch(choix) {
			case "1":
				...
				switch(regime) {
					case "non":
						s = new Sandwich<IPain, ISauce, IAliment>(nom);
						break;
					case "végétarien":
						s = new Sandwich<IPain, ISauce, IAlimentVegetarien>(nom);
						break;
					case "végan":
						s = new Sandwich<IPain, ISauce, IAlimentVegan>(nom);
						break;
					default:
						s = new Sandwich<IPain, ISauce, IAliment>(nom);
						break;
				}
				s.composer(pain, sauce, ingredients);
